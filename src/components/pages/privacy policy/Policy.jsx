                ...
                <div className="ppcontainer">
                    <div className="tab-content translations-content-item en visible ppsummry" id="en">
                        ...
                        <ul>
                            ...
                            <li>
                                <p><strong>Application</strong> refers to TripNThrill, the software program provided by the Company.</p>
                            </li>
                            <li>
                                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to TripNThrill LLP, TripNThrill, Inside Suvarna Complex, Sagar 577401.</p>
                            </li>
                            <li>
                        ...
                        <span className="text-[2rem] font-bold">Collecting and Using Your Personal Data</span>
                        ...
                        <span className="text-2xl font-bold">Children's Privacy</span>
                        ...
                        <span className="text-2xl font-bold">Changes to this Privacy Policy</span>
                        ...
                        <ul>
                            <li>
                                <p className='cursor-pointer' onClick={() => window.location = 'mailto:support@tripnthrill.com'}>By email: support@tripnthrill.com</p>
                            </li>
                            <li>
                                <p>By phone number: +91 9148939841</p>
                            </li>
                        </ul>
                    </div>
                </div>
