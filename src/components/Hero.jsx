    ...
    <div className='flex flex-col-reverse items-center justify-evenly w-full h-screen md:flex-row'>
      <div className='justify-center text-center mx-4 p-4 lg:max-w-1/2 sm:lg:max-w-full'>
        <div className='flex flex-col p-8 m-8'>
          ...
          <p className='font-sans py-4 text-indigo-600'>Our tours are carefully crafted to provide the perfect balance of relaxation and excitement. We offer luxurious accommodations, unparalleled sightseeing opportunities, and authentic local experiences that will stay with you long after your trip is over</p>
