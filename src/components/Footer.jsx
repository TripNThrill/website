      ...
      <div class="mx-6 py-10 text-center">
        <div class="grid grid-1 grid-cols-2 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div class="col-span-2 lg:col-span-1 border-4 rounded-xl flex flex-col items-center justify-center">
            ...
            <p class="mb-4">
              <Link to="#!" class="text-gray-600">Pricing</Link>
            </p>
            <p class="mb-4">
              <Link to="/contact" class="text-gray-600">Contact Us</Link>
            </p>
            <p>
              <Link to="/terms" class="text-gray-600">Terms and Conditions</Link>
            </p>
          </div>
          <div className="col-span-2 md:col-span-1 border-4 rounded-xl flex flex-col items-center justify-center">
            ...
            <div className="grid gap-2 grid-cols-3 place-content-center	">
              <div className="w-16 h-auto">
                <a href="https://tripnthrill.com/">
                  <img className="w-full border-2 rounded-lg" src="https://images.pexels.com/photos/1076240/pexels-photo-1076240.jpeg?auto=compress&cs=tinysrgb&w=600" alt='/' />
                </a>
              </div>
              <div className="w-16 h-auto">
                <a href="https://tripnthrill.com/" className="">
                  <img className="w-full border-2 rounded-lg" src="https://images.pexels.com/photos/4285355/pexels-photo-4285355.jpeg?auto=compress&cs=tinysrgb&w=600" alt='/' />
                </a>
              </div>
              <div className="w-16 h-auto">
                <a href="https://tripnthrill.com/" className="">
              ...
              <div className="w-16 h-auto">
                <a href="https://tripnthrill.com/" className="">
                  <img className="w-full border-2 rounded-lg" src="https://images.pexels.com/photos/7633609/pexels-photo-7633609.jpeg?auto=compress&cs=tinysrgb&w=600" alt='/' />
                </a>
              </div>
              <div className="w-16 h-auto">
                <a href="https://tripnthrill.com/" className="">
                  <img className="w-full border-2 rounded-lg" src="https://images.pexels.com/photos/206066/pexels-photo-206066.jpeg?auto=compress&cs=tinysrgb&w=600" alt='/' />
                </a>
              </div>
              <div className="w-16 h-auto">
                <a href="https://tripnthrill.com/" className="">
                  <img className="w-full border-2 rounded-lg" src="https://images.pexels.com/photos/4785057/pexels-photo-4785057.jpeg?auto=compress&cs=tinysrgb&w=600" alt='/' />
                </a>
              </div>
            </div>
          </div>
