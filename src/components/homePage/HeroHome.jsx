...
import HeroImage from '../../assets/Travelbus.jpg';

function HeroHome() {

    return (
        <section className="relative bg-[#E3F6FF]">
                ...
                <svg width="1360" height="578" viewBox="0 0 1360 578" xmlns="http://www.w3.org/2000/svg">
                    <defs>
                        <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="illustration-01">
                            <stop stopColor="#dbecfc" offset="0%" />
                            <stop stopColor="#012971" offset="77.402%" />
                            <stop stopColor="#b7cfff" offset="100%" />
                        </linearGradient>
                    </defs>
