...
const Bottom = () => {
  return (
    <div>
      <div className="sm:mb-10 md:bg-gray-300  lg:bg-white lg:h-full">
        <div className="container flex-col-reverse md:flex-row bg-white">
          ...
          <div className="w-full md:w-[30%] m-4">
            <img
